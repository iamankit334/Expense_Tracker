...
<head>
    ...
    <!-- Sweet Alert CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('assets/sweet_alert/sweetalert2.min.css')); ?>">

    <!-- Template Assets Style CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('assets/template_assets/css/style.css')); ?>">
</head>
...
<body>
    ...
    <div id="big_loader" class="my-2 justify-content-center align-items-center loader-body w-100 h-100 position-fixed m-0 top-0 mt-0" style="z-index: 999999">
        ...
        <img src="<?php echo e(asset('assets/img/custom_loader.svg')); ?>" class="img-fluid" alt="" style="width:8%;">
    </div>
            ...
            <ul class="nav user-menu">
                ...
                <li class="nav-item dropdown has-arrow main-drop">
                    <a href="#" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
                        <span class="user-img">
                            <img src="<?php echo e(asset('assets/img/user_image.jpg')); ?>" alt="">
                            <span class="status online"></span>
                        </span>
                        
                        <span><?php echo e(session::get('normalUserName')); ?></span>
                    </a>
            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul class="sidebar-vertical">
                        ...
                        <li class="active">
                            <a href="<?php echo e(URL('/dashboard')); ?>"><i class="fas fa-dashboard fa-xl"></i><span>Dashboard</span></a>
                        </li>
                        <li class="">
                            <a class="dashboard-iframe-links" target="dashboard-iframe" href="<?php echo e(URL('/dashboard/income?dsh=1')); ?>"><i class="fas fa-money-bill-trend-up fa-xl"></i> <span>Income</span></a>
                        </li>
                        <li class="">
                            <a class="dashboard-iframe-links" target="dashboard-iframe" href="<?php echo e(URL('/dashboard/expense?dsh=1')); ?>"><i class="fas fa-money-bill-transfer fa-lg"></i> <span>Expense</span></a>
                        </li>
                        <li class="">
                            <a class="dashboard-iframe-links" target="dashboard-iframe" href="<?php echo e(URL('/dashboard/bank_accounts?dsh=1')); ?>"><i class="fas fa-building-columns fa-xl"></i><span>Bank Accounts</span></a>
                        </li>
                        <li class="">
                            <a class="dashboard-iframe-links" target="dashboard-iframe" href="<?php echo e(URL('/dashboard/category?dsh=1')); ?>"><i class="fas fa-shapes fa-xl"></i><span>Category</span></a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="page-wrapper">
            ...
            <div class="dashboard-content container-fluid">
                ...
                <div class="page-header my-3">
                    <div class="row">
                        <div class="col-sm-12">
                            <h3 class="page-title">Welcome<?php echo e(Session::get('normalUserFsLgin') == 1 ? '' : ' back, '); ?> <?php echo e(session::get('normalUserName')); ?>!</h3>
                        </div>
                    </div>
                </div>
								...
								<div class="card dash-widget">
									<div class="card-body">
										...
										<div class="dash-widget-info">
											<h3>Rs <?php echo e($totalBalance < 0 ? 0 : number_format($totalBalance, 2, ".", ",")); ?></h3>
							...
							<div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6 col-sm-6">
								<div class="card dash-widget">
									<div class="card-body">
										...
										<div class="dash-widget-info">
											<h3>Rs <?php echo e(number_format($totalMonthlyIncomeValue, 2, ".", ",")); ?></h3>
							...
							<div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6 col-sm-6">
								<div class="card dash-widget">
									<div class="card-body">
										...
										<div class="dash-widget-info">
											<h3>Rs <?php echo e(number_format($totalMonthlyExpenseValue, 2, ".", ",")); ?></h3>
                                ...
                                <div class="table-responsive">
                                    <?php if(count($recentExpense) > 0): ?>
                                        <table class="table table-nowrap custom-table mb-0">
                                            ...
                                            <tbody>
                                                <?php $expenseId = 1; ?>
                                                <?php $__currentLoopData = $recentExpense; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rsRecentExpense): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        <td><?php echo e($expenseId); ?></td>
                                                        <td><?php echo e(\App\ASPLibraries\CustomFunctions::customDecrypt($rsRecentExpense->account_name, Session::get('normalUserEncryptKey'))); ?></td>
                                                        <td><?php echo e($rsRecentExpense->category_name); ?></td>
                                                        <td>Rs <?php echo e(number_format(\App\ASPLibraries\CustomFunctions::customDecrypt($rsRecentExpense->amount, Session::get('normalUserEncryptKey')), 2, ".", ",")); ?></td>
                                                        <td><?php echo e($rsRecentExpense->date); ?></td>
                                                    </tr>
                                                    <?php $expenseId++; ?>
                                ...
                                <div class="table-responsive">
                                    <?php if(count($recentIncome) > 0): ?>
                                        <table class="table custom-table table-nowrap mb-0">
                                            ...
                                            <tbody>
                                                <?php $incomeId = 1; ?>
                                                <?php $__currentLoopData = $recentIncome; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rsRecentIncome): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                    <td><?php echo e($incomeId); ?></td>
                                                    <td><?php echo e(\App\ASPLibraries\CustomFunctions::customDecrypt($rsRecentIncome->account_name, Session::get('normalUserEncryptKey'))); ?></td>
                                                    <td><?php echo e(\App\ASPLibraries\CustomFunctions::customDecrypt($rsRecentIncome->source, Session::get('normalUserEncryptKey'))); ?></td>
                                                    <td>Rs <?php echo e(number_format(\App\ASPLibraries\CustomFunctions::customDecrypt($rsRecentIncome->amount, Session::get('normalUserEncryptKey')), 2, ".", ",")); ?></td>
                                                    <td><?php echo e($rsRecentIncome->date); ?></td>
                                                    </tr>
                                                    <?php $incomeId++; ?>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </tbody>
                                ...
                                <div class="row mx-auto p-0 m-0">
                                    <div class="col-lg-6 col-md-12 p-0 pe-xxl-2 pe-xl-2 pe-lg-2 pe-md-0">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" placeholder="Your name" id="edit_prof_name" name="edit_prof_name" value="<?php echo e(session::get('normalUserName')); ?>">
                                    ...
                                    <div class="col-lg-6 col-md-12 p-0 ps-xxl-2 ps-xl-2 ps-lg-2 ps-md-0">
                                        <div class="form-floating mb-3">
                                            <input type="email" class="form-control" placeholder="Your email" id="edit_prof_email" name="edit_prof_email" value="<?php echo e(session::get('normalUserEmail')); ?>">
    ...
    <script src="<?php echo e(URL('/assets/js/dash.js')); ?>"></script>
    <!-- Custom JavaScript -->
    ...
    <script src="<?php echo e(asset('assets/template_assets/js/app.js')); ?>"></script>
</body>
</html><?php /**PATH C:\Users\LENOVO\OneDrive\Desktop\laravel\new_app\Expense-Tracker-main\expt_lvl\resources\views/dashboard.blade.php ENDPATH**/ ?>