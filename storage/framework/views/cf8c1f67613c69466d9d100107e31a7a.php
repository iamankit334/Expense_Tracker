...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(URL('assets/template_assets/css/dataTables.bootstrap4.min.css')); ?>">
</head>
<body>
    ...
    <?php echo $__env->make('includes/dynamic_sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <div class="dashboard-content container-fluid">
        ...
        <div class="row">
                ...
                <div class="stats-info">
                    ...
                    <?php if(count($expenseList) > 0): ?>
                        <?php $__currentLoopData = $expenseList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rsExpenseList): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <h4><span>Rs </span><?php echo e(number_format(\App\ASPLibraries\CustomFunctions::customDecrypt($rsExpenseList->amount, Session::get('normalUserEncryptKey')), 2, ".", ",")); ?></h4>
                            <?php break; ?>
            ...
            <div class="col-md-4">
                <div class="stats-info">
                    ...
                    <h4><span>Rs </span><?php echo e(number_format($currentMonthsTotalExpense, 2, ".", ",")); ?></h4>
                </div>
            </div>
            <div class="col-md-4">
                <div class="stats-info">
                    <h6>Total Expense</h6>
                    <h4><span>Rs </span><?php echo e(number_format($totalExpense, 2, ".", ",")); ?></h4>
                </div>
            </div>
        </div>
            ...
            <div class="col-sm-6 col-md-3 col-lg-3 col-xl-3 col-12 mb-3">
                <div class="form-floating">
                    <select class="form-select" id="filter_expense_account" name="filter_expense_account">
                        ...
                        <?php $__currentLoopData = $bankAccountsName; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rsBankAccountsName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($rsBankAccountsName->id); ?>"><?php echo e(\App\ASPLibraries\CustomFunctions::customDecrypt($rsBankAccountsName->account_name, Session::get('normalUserEncryptKey'))); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
        ...
        <div class="row expense_body">
            <?php echo $__env->make('ajax/ajax_expense_body', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    </div>
    ...
    <?php echo $__env->make('includes/dynamic_sidebar_footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    ...
                    <form action="javascript:void(0);">
                        ...
                        <div class="form-floating mb-3">
                            <select class="form-select" id="add_expense_category" name="add_expense_category">
                                ...
                                <?php $__currentLoopData = $categoryName; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rsCategoryName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($rsCategoryName->id); ?>"><?php echo e($rsCategoryName->category_name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
...
<!-- Expense JavaScript -->
<script src="<?php echo e(URL('/assets/js/exp.js')); ?>"></script>
<!-- Custom JavaScript -->
...
<script src="<?php echo e(URL('assets/template_assets/js/jquery.dataTables.min.js')); ?>"></script>
<!-- Template Assets Bootstrap Datatables Js -->
<script src="<?php echo e(URL('assets/template_assets/js/dataTables.bootstrap4.min.js')); ?>"></script>
</body>
</html><?php /**PATH C:\Users\LENOVO\OneDrive\Desktop\laravel\new_app\Expense-Tracker-main\expt_lvl\resources\views/expense.blade.php ENDPATH**/ ?>