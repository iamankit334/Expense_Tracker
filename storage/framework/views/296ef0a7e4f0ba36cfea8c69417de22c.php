...
<body class="account-page">
        ...
        <div class="account-content">
            <div class="container">
                <div class="account-logo">
                    <a href="<?php echo e(URL('/')); ?>"><img src="<?php echo e(asset('assets/img/logo.png')); ?>" alt="Expense Tracker"></a>
                </div>
                    ...
                    <div class="account-wrapper">
                        ...
                        <form action="javascript:void(0)">
                            ...
                            <div id="register-loader" class="my-2 d-none loader-body">
                                <img src="<?php echo e(asset('assets/img/custom_loader.svg')); ?>" class="loader-img" alt="">
                            </div>
                            ...
                            <div class="account-footer">
                                <p>Already have an account? <a href="<?php echo e(URL('/')); ?>">Login!</a></p>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <!-- jQuery File -->
    <script src="<?php echo e(asset('assets/js/jquery_3.6.3.min.js')); ?>"></script>
    <!-- Custom JavaScript -->
    <script src="<?php echo e(asset('assets/js/authHandler.js')); ?>"></script>
    <!-- Sweet Alert Js -->
    <script src="<?php echo e(asset('assets/sweet_alert/sweetalert2.min.js')); ?>"></script>

    <!-- Template Assets App Js -->
    <script src="<?php echo e(asset('assets/template_assets/js/app.js')); ?>"></script>
</body>

</html><?php /**PATH C:\Users\LENOVO\OneDrive\Desktop\laravel\new_app\Expense-Tracker-main\expt_lvl\resources\views/registration.blade.php ENDPATH**/ ?>