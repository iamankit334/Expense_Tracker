...
<body>
    ...
    <div class="dashboard-content container-fluid">
        ...
        <div class="row">
                ...
                <div class="stats-info">
                    ...
                    <?php if(count($incomeList) > 0): ?>
                        <?php $__currentLoopData = $incomeList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rsIncomeList): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <h4><span>Rs </span><?php echo e(number_format(\App\ASPLibraries\CustomFunctions::customDecrypt($rsIncomeList->amount, Session::get('normalUserEncryptKey')), 2, ".", ",")); ?></h4>
                            <?php break; ?>
            ...
            <div class="col-md-4">
                <div class="stats-info">
                    ...
                    <h4><span>Rs </span><?php echo e(number_format($currentMonthsTotalIncome, 2, ".", ",")); ?></h4>
                </div>
            </div>
            <div class="col-md-4">
                <div class="stats-info">
                    <h6>Total Income</h6>
                    <h4><span>Rs </span><?php echo e(number_format($totalIncome, 2, ".", ",")); ?></h4>
                </div>
            </div>
        </div>
        ...
        <div class="row income_body">
            <?php echo $__env->make('ajax/ajax_income_body', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    </div>
    ...
    <!-- Income JavaScript -->
    <script src="<?php echo e(URL('/assets/js/inc.js')); ?>"></script>
    <!-- Custom JavaScript -->
...
</html><?php /**PATH C:\Users\LENOVO\OneDrive\Desktop\laravel\new_app\Expense-Tracker-main\expt_lvl\resources\views/income.blade.php ENDPATH**/ ?>