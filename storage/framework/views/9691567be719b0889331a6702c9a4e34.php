...
<body>
    ...
    <div class="dashboard-content container-fluid">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="stats-info">
                    ...
                    <h4><?php echo e($bankAccountNameDesc == '' ? '(N/A)' : $bankAccountNameDesc); ?></h4>
                </div>
            </div>
            <div class="col-md-6">
                <div class="stats-info">
                    <h6>Low Balance Account</h6>
                    <h4><?php echo e($bankAccountNameAsc == '' ? '(N/A)' : $bankAccountNameAsc); ?></h4>
                </div>
            </div>
        ...
        <div class="row bank_accounts_body">
            <?php echo $__env->make('ajax/ajax_bank_account_body', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    </div>
    ...
    <script src="<?php echo e(URL('/assets/js/bankAcc.js')); ?>"></script>
    <!-- Custom JavaScript -->
...
</html><?php /**PATH C:\Users\LENOVO\OneDrive\Desktop\laravel\new_app\Expense-Tracker-main\expt_lvl\resources\views/bank_accounts.blade.php ENDPATH**/ ?>