...
<body>
	...
	<div class="dashboard-content container-fluid">
		...
		<div class="row category_filter_body">
			<?php echo $__env->make('ajax/ajax_category_body', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
		</div>
	</div>
    ...
    <!-- Category JavaScript -->
    <script src="<?php echo e(URL('/assets/js/cat.js')); ?>"></script>
    <!-- Custom JavaScript -->
...
</html><?php /**PATH C:\Users\LENOVO\OneDrive\Desktop\laravel\new_app\Expense-Tracker-main\expt_lvl\resources\views/category.blade.php ENDPATH**/ ?>